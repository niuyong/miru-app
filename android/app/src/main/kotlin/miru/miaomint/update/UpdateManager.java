...
//                }
     ...
     */
    private void showUpdateDialog(final String fileName, final String detail) {
        ConfirmDialog dialog = new ConfirmDialog(context, () -> showDownloadDialog(fileName));
        dialog.setTitle(R.string.note_confirm_title);
        dialog.setContent(context.getString(R.string.layout_version_new) + "\n" + detail);
